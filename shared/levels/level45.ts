...
import { FLOOR_TOP, STACK2_FEET_PEAK, STACK3_FEET_PEAK, goalOnFloor, groundRect, groundSegment, floorButton, fullHeightDoor, standardSpawns, platformRect, fireBar, floorTrap, crumbleNoRespawn, lavaWall, pushBox, floorSpring, movingPlatform } from './_helpers';
...
// L45 — "Final Legion" (Squad Legion): all mechanics, 5120 px, wall 80 px/s.
// Boxes start at 2500+ (after lava45b and lava45c), buttons at 2600+.
export const LEVEL_45: LevelData = {
  ...
  objects: [
    ...
    floorTrap('lava45b', 1875, 350),
    fireBar('fb45a', 1400, FLOOR_TOP - 48, 2, 1.1, 0),
    ferry,
    floorButton('btn45a', 1340, 'door45a', { latching: true }),
    fullHeightDoor('door45a', 2100),
    // Boxes start at 2500+ (after lava45b ends at 2050), pushed right to 2600+
    pushBox('box45a', 2500, FLOOR_TOP - 32),
    pushBox('box45b', 2650, FLOOR_TOP - 32),
    floorButton('btn45b', 2800, 'door45b', { latching: false }),
    floorButton('btn45c', 2950, 'door45b', { latching: false }),
    fullHeightDoor('door45b', 3100),
